...
const GROUP_MATCHES = [
  ...
  {id:"A3",phase:"Gruppe",group:"A",home:"Mexiko",away:"Südkorea",date:"19.06.2026",time:"03:00"},
  {id:"A4",phase:"Gruppe",group:"A",home:"Tschechien",away:"Südafrika",date:"18.06.2026",time:"18:00"},
  {id:"A5",phase:"Gruppe",group:"A",home:"Mexiko",away:"Tschechien",date:"25.06.2026",time:"03:00"},
  {id:"A6",phase:"Gruppe",group:"A",home:"Südafrika",away:"Südkorea",date:"25.06.2026",time:"03:00"},
  // GRUPPE B
  ...
  {id:"B3",phase:"Gruppe",group:"B",home:"Kanada",away:"Katar",date:"19.06.2026",time:"00:00"},
  {id:"B4",phase:"Gruppe",group:"B",home:"Schweiz",away:"Bosnien-Herzegowina",date:"18.06.2026",time:"21:00"},
  ...
  {id:"C3",phase:"Gruppe",group:"C",home:"Brasilien",away:"Haiti",date:"20.06.2026",time:"02:30"},
  {id:"C4",phase:"Gruppe",group:"C",home:"Marokko",away:"Schottland",date:"20.06.2026",time:"00:00"},
  {id:"C5",phase:"Gruppe",group:"C",home:"Brasilien",away:"Schottland",date:"25.06.2026",time:"00:00"},
  {id:"C6",phase:"Gruppe",group:"C",home:"Marokko",away:"Haiti",date:"25.06.2026",time:"00:00"},
  // GRUPPE D
  ...
  {id:"E4",phase:"Gruppe",group:"E",home:"Ecuador",away:"Curaçao",date:"21.06.2026",time:"02:00"},
  ...
  {id:"F3",phase:"Gruppe",group:"F",home:"Niederlande",away:"Schweden",date:"20.06.2026",time:"19:00"},
  {id:"F4",phase:"Gruppe",group:"F",home:"Japan",away:"Tunesien",date:"21.06.2026",time:"06:00"},
  {id:"F5",phase:"Gruppe",group:"F",home:"Niederlande",away:"Tunesien",date:"26.06.2026",time:"01:00"},
  {id:"F6",phase:"Gruppe",group:"F",home:"Japan",away:"Schweden",date:"26.06.2026",time:"01:00"},
  // GRUPPE G
  ...
  {id:"G3",phase:"Gruppe",group:"G",home:"Belgien",away:"Neuseeland",date:"27.06.2026",time:"05:00"},
  {id:"G4",phase:"Gruppe",group:"G",home:"Ägypten",away:"Iran",date:"27.06.2026",time:"05:00"},
  {id:"G5",phase:"Gruppe",group:"G",home:"Belgien",away:"Iran",date:"21.06.2026",time:"21:00"},
  {id:"G6",phase:"Gruppe",group:"G",home:"Ägypten",away:"Neuseeland",date:"22.06.2026",time:"03:00"},
  // GRUPPE H
  ...
  {id:"H3",phase:"Gruppe",group:"H",home:"Spanien",away:"Saudi-Arabien",date:"21.06.2026",time:"18:00"},
  {id:"H4",phase:"Gruppe",group:"H",home:"Uruguay",away:"Kap Verde",date:"22.06.2026",time:"00:00"},
  {id:"H5",phase:"Gruppe",group:"H",home:"Spanien",away:"Uruguay",date:"27.06.2026",time:"02:00"},
  {id:"H6",phase:"Gruppe",group:"H",home:"Kap Verde",away:"Saudi-Arabien",date:"27.06.2026",time:"02:00"},
  // GRUPPE I
  ...
  {id:"I3",phase:"Gruppe",group:"I",home:"Frankreich",away:"Irak",date:"22.06.2026",time:"23:00"},
  {id:"I4",phase:"Gruppe",group:"I",home:"Norwegen",away:"Senegal",date:"23.06.2026",time:"02:00"},
  {id:"I5",phase:"Gruppe",group:"I",home:"Frankreich",away:"Norwegen",date:"26.06.2026",time:"21:00"},
  {id:"I6",phase:"Gruppe",group:"I",home:"Senegal",away:"Irak",date:"26.06.2026",time:"21:00"},
  // GRUPPE J
  ...
  {id:"J5",phase:"Gruppe",group:"J",home:"Argentinien",away:"Jordanien",date:"28.06.2026",time:"04:00"},
  {id:"J6",phase:"Gruppe",group:"J",home:"Algerien",away:"Österreich",date:"28.06.2026",time:"04:00"},
  // GRUPPE K
  {id:"K1",phase:"Gruppe",group:"K",home:"Portugal",away:"DR Kongo",date:"17.06.2026",time:"19:00"},
  {id:"K2",phase:"Gruppe",group:"K",home:"Usbekistan",away:"Kolumbien",date:"18.06.2026",time:"04:00"},
  {id:"K3",phase:"Gruppe",group:"K",home:"Portugal",away:"Usbekistan",date:"23.06.2026",time:"19:00"},
  {id:"K4",phase:"Gruppe",group:"K",home:"Kolumbien",away:"DR Kongo",date:"24.06.2026",time:"04:00"},
  {id:"K5",phase:"Gruppe",group:"K",home:"Portugal",away:"Kolumbien",date:"28.06.2026",time:"01:30"},
  {id:"K6",phase:"Gruppe",group:"K",home:"DR Kongo",away:"Usbekistan",date:"28.06.2026",time:"01:30"},
  // GRUPPE L
  ...
  {id:"L4",phase:"Gruppe",group:"L",home:"Kroatien",away:"Panama",date:"24.06.2026",time:"01:00"},
...
export default function App(){
  ...
  const loadKoAssignments=useCallback(async()=>{
    try{const rows=await sb("ko_assignments?select=match_id,home,away,date,time");const map={};(rows||[]).forEach(r=>{map[r.match_id]={home:r.home,away:r.away,date:r.date,time:r.time};});setKoAssignments(map);}catch(e){console.error(e);}
  },[]);

  const allMatches=useMemo(()=>GROUP_MATCHES.concat(KO_MATCHES.map(m=>{
    const ass=koAssignments[m.id];
    if(!ass)return m;
    return {...m,home:ass.home||m.home,away:ass.away||m.away,date:ass.date||m.date,time:ass.time||m.time,locked:(ass.home&&ass.away)?false:m.locked};
  })),[koAssignments]);
  ...
  const saveTip=async(matchId,home,away)=>{
    ...
    try{
      await sbUpsert("tips","user_id,match_id",body,session.access_token);
  ...
  const saveSpecialTip=async(betId,value)=>{
    ...
    try{
      await sbUpsert("special_tips","user_id,bet_id",body,session.access_token);
  ...
  const deleteResult=async(matchId)=>{
    if(!session)return;
    try{
      await sb(`results?match_id=eq.${matchId}`,"DELETE",null,session.access_token);
      setResults(r=>{const n={...r};delete n[matchId];return n;});
      loadLeaderboard();notify("Ergebnis gelöscht ✓");
    }catch(e){console.error(e);notify("⚠️ Ergebnis konnte nicht gelöscht werden!","err");}
  };

  const saveKoAssignment=async(matchId,home,away,date,time)=>{
    if(!session||!home||!away||!date||!time)return;
    const body={match_id:matchId,home,away,date,time,updated_at:new Date().toISOString()};
    try{
      await sbUpsert("ko_assignments","match_id",body,session.access_token);
      setKoAssignments(k=>({...k,[matchId]:{home,away,date,time}}));
      notify(`Paarung gesetzt: ${home} vs ${away} (${date} ${time} Uhr) ✓`);
  ...
  return(
    <div style={S.root}>
      ...
      <main style={S.main}>
        ...
        {page==="tips"&&<TipsPage session={session} profile={profile} tips={tips} results={results} allMatches={allMatches} saveTip={saveTip} submitTip={submitTip} saveResult={saveResult} deleteResult={deleteResult} saveKoAssignment={saveKoAssignment} setPage={setPage}/>}
...
function TipsPage({session,profile,tips,results,allMatches,saveTip,submitTip,saveResult,deleteResult,saveKoAssignment,setPage}){
  ...
  return(<div style={S.tipsWrap}>
    ...
    <div style={S.matchGrid}>{phaseMatches.map(m=>(<MatchCard key={m.id} match={m} tip={tips[m.id]} result={results[m.id]} onTip={(h,a)=>saveTip(m.id,h,a)} onSubmit={(h,a)=>submitTip(m.id,h,a)} onResult={(h,a)=>saveResult(m.id,h,a)} onDeleteResult={()=>deleteResult(m.id)} onAssignTeams={(h,a,d,t)=>saveKoAssignment(m.id,h,a,d,t)} isAdmin={profile?.is_admin}/>))}</div>
  </div>);
}
...
function MatchCard({match,tip,result,onTip,onSubmit,onResult,onDeleteResult,onAssignTeams,isAdmin}){
  ...
  const[th,setTh]=useState(match.home!=="TBD"?match.home:"");const[ta,setTa]=useState(match.away!=="TBD"?match.away:"");
  const[kd,setKd]=useState(match.date);const[kt,setKt]=useState(match.time);
  ...
  useEffect(()=>{setTh(match.home!=="TBD"?match.home:"");setTa(match.away!=="TBD"?match.away:"");setKd(match.date);setKt(match.time);},[match.home,match.away,match.date,match.time]);
  ...
  return(<div style={S.mCard}>
    ...
    <div style={S.mBottom}>
      ...
      {isAdmin&&match.phase!=="Gruppe"&&(<div style={S.adminRow}>
        <span style={S.adminLabel}>Admin – Paarung &amp; Termin:</span>
        <select style={{width:150}} value={th} onChange={e=>setTh(e.target.value)}>
          <option value="">– Team 1 –</option>
          {ALL_TEAMS.sort().map(t=>(<option key={t} value={t}>{FLAG[t]||"🏳️"} {t}</option>))}
        </select>
        <span style={{color:"#888"}}>vs</span>
        <select style={{width:150}} value={ta} onChange={e=>setTa(e.target.value)}>
          <option value="">– Team 2 –</option>
          {ALL_TEAMS.sort().map(t=>(<option key={t} value={t}>{FLAG[t]||"🏳️"} {t}</option>))}
        </select>
        <input style={{...S.scoreInSm,width:90,fontSize:13}} type="text" value={kd} placeholder="TT.MM.JJJJ" onChange={e=>setKd(e.target.value)}/>
        <input style={{...S.scoreInSm,width:60,fontSize:13}} type="text" value={kt} placeholder="HH:MM" onChange={e=>setKt(e.target.value)}/>
        <button style={S.saveBtn} disabled={!th||!ta||th===ta||!kd||!kt} onClick={()=>onAssignTeams(th,ta,kd,kt)}>✓ Setzen</button>
      </div>)}
      {isAdmin&&!isTbd&&!match.locked&&(<div style={S.adminRow}>
        ...
        {result&&<button style={{...S.saveBtn,background:"#c0392b",color:"#fff"}} onClick={onDeleteResult}>🗑 Löschen</button>}
      </div>)}
    </div>
  </div>);
}
